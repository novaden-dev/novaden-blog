...
title: Novaden v2 The Useful Homelab
slug: novaden-v2-homelab
featured: false
draft: false
tags: ["selfhosting"]
category: journal
description: The second version of my homelab. When it actually became useful
---

So I tore down the previous version of my homelab, rm -rf style tearing down. I then started over, I kept proxmox and started building lxc containers.
...
Then, randomly: "maliit-keyboard killed by SIGABRT" popped up, in Turkish. I don't know why but that's 1 point on the I fucked up by installing Linux scoreboard.
...
If you move your mouse repeatedly, the cursor grows. Apparently I spin it when stressed, this feature made me more aware of the times I do this. There's also an OS-level zoom I discovered by panic when I enabled it by accident and freaked out for minutes trying to figure out what happened.
